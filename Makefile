...
pkgdatadir = $(datadir)/arm_simulator
pkgincludedir = $(includedir)/arm_simulator
pkglibdir = $(libdir)/arm_simulator
pkglibexecdir = $(libexecdir)/arm_simulator
...
am__objects_1 = csapp.$(OBJEXT) scanner.$(OBJEXT) debug.$(OBJEXT) \
	gdb_protocol.$(OBJEXT) util.$(OBJEXT) trace.$(OBJEXT) \
	memory.$(OBJEXT) registers.$(OBJEXT) arm.$(OBJEXT) \
	arm_constants.$(OBJEXT) arm_core.$(OBJEXT) \
	arm_exception.$(OBJEXT) arm_instruction.$(OBJEXT) \
	arm_data_processing.$(OBJEXT) arm_load_store.$(OBJEXT) \
	arm_branch_other.$(OBJEXT)
...
arm_simulator_DEPENDENCIES =
am_memory_test_OBJECTS = memory_test.$(OBJEXT) memory.$(OBJEXT) \
	util.$(OBJEXT)
memory_test_OBJECTS = $(am_memory_test_OBJECTS)
memory_test_LDADD = $(LDADD)
memory_test_DEPENDENCIES =
am_send_irq_OBJECTS = send_irq.$(OBJEXT) csapp.$(OBJEXT) \
	arm_constants.$(OBJEXT)
send_irq_OBJECTS = $(am_send_irq_OBJECTS)
send_irq_LDADD = $(LDADD)
send_irq_DEPENDENCIES =
AM_V_P = $(am__v_P_$(V))
...
am__depfiles_remade = ./$(DEPDIR)/arm.Po \
	...
	./$(DEPDIR)/gdb_protocol.Po ./$(DEPDIR)/memory.Po \
	./$(DEPDIR)/memory_test.Po ./$(DEPDIR)/registers.Po \
	./$(DEPDIR)/scanner.Po ./$(DEPDIR)/send_irq.Po \
	./$(DEPDIR)/trace.Po ./$(DEPDIR)/util.Po
am__mv = mv -f
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	...
	AUTHORS COPYING ChangeLog INSTALL README build-aux/compile \
...
ACLOCAL = ${SHELL} /home/p/perellep/Prog/Projet/arm_simulator-1.4/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/p/perellep/Prog/Projet/arm_simulator-1.4/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/p/perellep/Prog/Projet/arm_simulator-1.4/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/p/perellep/Prog/Projet/arm_simulator-1.4/build-aux/missing automake-1.16
AWK = gawk
CC = gcc
CCAS = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/p/perellep/Prog/Projet/arm_simulator-1.4/build-aux/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = arm_simulator
PACKAGE_BUGREPORT = Guillaume.Huard@imag.fr
PACKAGE_NAME = Arm_Simulator
PACKAGE_STRING = Arm_Simulator 1.4
PACKAGE_TARNAME = arm_simulator
PACKAGE_URL = 
PACKAGE_VERSION = 1.4
PATH_SEPARATOR = :
SET_MAKE = 
...
STRIP = 
VERSION = 1.4
abs_builddir = /home/p/perellep/Prog/Projet/arm_simulator-1.4
abs_srcdir = /home/p/perellep/Prog/Projet/arm_simulator-1.4
abs_top_builddir = /home/p/perellep/Prog/Projet/arm_simulator-1.4
abs_top_srcdir = /home/p/perellep/Prog/Projet/arm_simulator-1.4
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/p/perellep/Prog/Projet/arm_simulator-1.4/build-aux/install-sh
...
AM_CFLAGS = -D DEBUG -D WARNING -D BIG_ENDIAN_SIMULATOR
...
memory_test$(EXEEXT): $(memory_test_OBJECTS) $(memory_test_DEPENDENCIES) $(EXTRA_memory_test_DEPENDENCIES) 
	...
	$(AM_V_CCLD)$(LINK) $(memory_test_OBJECTS) $(memory_test_LDADD) $(LIBS)

send_irq$(EXEEXT): $(send_irq_OBJECTS) $(send_irq_DEPENDENCIES) $(EXTRA_send_irq_DEPENDENCIES) 
	@rm -f send_irq$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(send_irq_OBJECTS) $(send_irq_LDADD) $(LIBS)
...
include ./$(DEPDIR)/arm_simulator.Po # am--include-marker
...
include ./$(DEPDIR)/memory_test.Po # am--include-marker
include ./$(DEPDIR)/registers.Po # am--include-marker
include ./$(DEPDIR)/scanner.Po # am--include-marker
include ./$(DEPDIR)/send_irq.Po # am--include-marker
include ./$(DEPDIR)/trace.Po # am--include-marker
